...
export const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await login(email, password, { requireStudent: true });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-blue-50 dark:from-dark-900 dark:to-dark-800 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Your Academic Companion</p>
        </div>
        ...
        <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold py-2.5 rounded-lg transition-all disabled:opacity-50"
            >
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 text-sm mt-4 pt-4 border-t border-gray-200 dark:border-dark-700">
            Upload materials?{' '}
